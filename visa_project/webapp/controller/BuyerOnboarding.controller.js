sap.ui.define([
	...
	"sap/m/MessageBox",
    'sap/m/Token'
], function (BaseController, JSONModel, MessageToast, MessageBox,Token) {
	"use strict";

	return BaseController.extend("visaproject.controller.BuyerOnboarding", {
		onInit: function () {

            var oView = this.getView();
            var oMultiInput1 = oView.byId("CompanyAdditionalEmailAddress");
		...
		// 	}
		// },
		activateBuyerInfoStep: function () {
			this._wizard.validateStep(this.byId("ProductInfoStep"));
		},
