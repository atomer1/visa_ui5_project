		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#visarequestinformation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"visarequestinformation-display": {
								"semanticObject": "visarequestinformation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=visarequestinformation",
									"url": sap.ui.require.toUrl("visarequestinformation")
								}
							}
						}
					}
